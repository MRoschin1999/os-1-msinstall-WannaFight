"7z1604-x64.msi" /passive /norestart /le "C:\Users\%username%\Desktop\7zip-log.txt" TARGETDIR="C:\Program Files\7-Zip"
...
"LibreOffice_6.4.2_Win_x86.msi" /passive /norestart /le "C:\Users\%username%\Desktop\libreoffice-install-log.txt"
